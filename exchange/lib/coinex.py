...
class CoinEx:
    ...
    def margin_loan_get(self, market, coin_type, account_id):
        return self._v1(f'res/margin/loan?account_id{account_id}', method='get', auth=True, market=market, coin_type=coin_type, account_id = account_id)
